...
{
	partial class ModifierVoitureForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ModifierVoitureForm));
			...
			this.carBindingSource1.DataSource = this.autoecoleDataSet;
			// 
			// label2
			// 
			...
			this.label4.Text = "Boite de vitesse";
			// 
			// label5
			// 
			...
			// textBox2
			// 
			this.textBox2.Location = new System.Drawing.Point(179, 186);
			...
			this.comboBox2.Location = new System.Drawing.Point(179, 251);
			...
			this.button1.Text = "Modifier la voiture";
			...
			this.button2.Text = "Supprimer la voiture";
			...
			this.carBindingSource2.DataSource = this.autoecoleDataSet;
			// 
			// ModifierVoitureForm
			// 
			...
			this.Name = "ModifierVoitureForm";
			this.Text = "Modifier une voiture";
			this.Load += new System.EventHandler(this.ModifierVoitureForm_Load);
